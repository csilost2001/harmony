...
import { assertSafeName, assertKind, assertEntityId } from "../security/idValidator.js";
...
export const processFlowHandlers: RpcHandlerMap = {
  ...
  loadViewDefinition: async ({ params, root, respond }) => {
    ...
    // S-002: ID validation
    assertEntityId(viewDefinitionId, "viewDefinitionId");
