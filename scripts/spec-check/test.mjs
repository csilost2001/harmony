...
// =============================================================================
// 3c. kind 別固有 schema AJV strict gate (#1064 / #1066 / #1068)
//     data-contract / domain-type / exception-type / application-rule /
...
// =============================================================================
console.log("\n## kind-specific schema AJV strict gate (data-contract / domain-type / exception-type / application-rule / runtime-policy / ui-behavior, #1064 / #1066 / #1068)");
{
  const { default: Ajv2020 } = await import("ajv/dist/2020.js");
  const { default: addFormats } = await import("ajv-formats");
  const ajv = new Ajv2020({ strict: false, allErrors: true });
  ...
  if (existsSync(retailGdRoot2)) {
    ...
    // application-rule / runtime-policy / ui-behavior #1068)
