...
const dummyGroups = [
  { id: "action-list-login-flow", no: 1, name: "ログイン処理", flowType: "screen", actionCount: 3, screenId: "screen-1", updatedAt: FIXED_TS },
  { id: "action-list-monthly-batch", no: 2, name: "月次集計バッチ", flowType: "batch", actionCount: 5, updatedAt: FIXED_TS },
  { id: "action-list-common-validation", no: 3, name: "共通バリデーション", flowType: "common", actionCount: 2, updatedAt: FIXED_TS },
];
